...
export const searchMovieDescriptionUsingL2similarityRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
  return queryRef(dcInstance, 'SearchMovieDescriptionUsingL2Similarity', inputVars);
}
searchMovieDescriptionUsingL2similarityRef.operationName = 'SearchMovieDescriptionUsingL2Similarity';
